...
(function() {
  window.__APPLET_REGISTRY__ = [
  {
    ...
    "icon": "applets/color-match/assets/icon.svg",
    "minDurationMs": 15000,
    "maxDurationMs": 25000,
    "difficulty": [
      "easy",
  ...
  },
  {
    ...
    "name": "Hyper Run",
    "version": "1.0.0",
    "entry": "applets/hyper-run/index.html",
    "icon": "applets/hyper-run/assets/icon.svg",
    "minDurationMs": 12000,
    "maxDurationMs": 15000,
    "difficulty": [
      "easy",
    ...
    "prerequisites": [],
    "notes": "Dodge neon barriers for a 12-second sprint to survive."
  },
  {
    "id": "orb-dodge",
    "name": "Orb Dodge",
